...
\begin{itemize}
	...
	\item c
		...
		\item d: 1 und zweiter Punkt tauschen
\end{figure}		
...
\begin{itemize}
	...
	\item b: $x =\frac{1}{2}$
	\item c: $x \approx 0.38448$. Das Merkmal $x=0.3$ wird nach $C_1$ klassifiziert.
	\item d: $x \approx 0.4574$
	\item e: $x_1 \approx 0.3844, x_2\approx 0.6155$
\end{itemize}
...
\begin{itemize}
	...
	\item d: Das nur die Geraden erkannt werden welche in der Abtastung enthalten sind.
\end{itemize}
